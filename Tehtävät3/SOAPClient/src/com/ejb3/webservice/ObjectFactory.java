...
public class ObjectFactory {
    ...
    private final static QName _AddBook_QNAME = new QName("http://webservice.ejb3.com/", "addBook");
    private final static QName _AddBookResponse_QNAME = new QName("http://webservice.ejb3.com/", "addBookResponse");
    private final static QName _GetAllBooks_QNAME = new QName("http://webservice.ejb3.com/", "getAllBooks");
    private final static QName _GetAllBooksResponse_QNAME = new QName("http://webservice.ejb3.com/", "getAllBooksResponse");
    private final static QName _Initiate_QNAME = new QName("http://webservice.ejb3.com/", "initiate");
    private final static QName _InitiateResponse_QNAME = new QName("http://webservice.ejb3.com/", "initiateResponse");
    ...
    /**
     * Create an instance of {@link InitiateResponse }
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://webservice.ejb3.com/", name = "addBook")
     ...
     */
    @XmlElementDecl(namespace = "http://webservice.ejb3.com/", name = "addBookResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://webservice.ejb3.com/", name = "getAllBooks")
     ...
     */
    @XmlElementDecl(namespace = "http://webservice.ejb3.com/", name = "getAllBooksResponse")
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link Initiate }{@code >}
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link Initiate }{@code >}
     */
    @XmlElementDecl(namespace = "http://webservice.ejb3.com/", name = "initiate")
    public JAXBElement<Initiate> createInitiate(Initiate value) {
        return new JAXBElement<Initiate>(_Initiate_QNAME, Initiate.class, null, value);
    }

    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link InitiateResponse }{@code >}
     * 
     * @param value
     *     Java instance representing xml element's value.
     * @return
     *     the new instance of {@link JAXBElement }{@code <}{@link InitiateResponse }{@code >}
     */
    @XmlElementDecl(namespace = "http://webservice.ejb3.com/", name = "initiateResponse")
    public JAXBElement<InitiateResponse> createInitiateResponse(InitiateResponse value) {
        return new JAXBElement<InitiateResponse>(_InitiateResponse_QNAME, InitiateResponse.class, null, value);
    }
