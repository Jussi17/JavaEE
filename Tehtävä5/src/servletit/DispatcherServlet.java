 ...
 * suorittaa palveluja sovellukselle. T‰ss‰ tapauksessa
 * palveluservletti ottaa yhteyden kantaan, suorittaa tietokantahaun ja tallentaa tuloksen
 * papu-olioon.
 *
 * Sessioon tallennetun papu-olion avulla v‰litet‰‰n kyselyn tulos k‰yttˆliittym‰‰n
 * asiakkaat.jsp-sivulle. N‰in saadaan aikaan paremmin MVC-mallia noudattava sovellus.
 *
 */
...
public class DispatcherServlet extends HttpServlet {
	...
	/*
	 * init-metodi suoritetaan aina kun Servletti otetaan k‰yttˆˆn. Se soveltuu
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response)
		...
		// K‰sitell‰‰n lomake
		// Tehd‰‰n tietokantahaku ja tallennetaan tiedot papuun
